using Bor;
using Bor.Extensions.Strings;
using Bor.ServiceAPI;
using System;
...
namespace Bor.Tools
{
    ...
    public class Auth : ICmd
    {
        ...
        public Auth(Bor.ServiceAPI.IAuthStorageService authStorageService)
        {
        ...
        public Task ExecuteAsync(string[] args)
        {
            ...
            {
                pwd = Bor.XrmOrganization.ConnectionString.GetPassword();
            }
