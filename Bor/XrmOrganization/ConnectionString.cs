...
namespace Bor.XrmOrganization
{
    public class ConnectionString
    {
        ...
        {
            if (System.IO.File.Exists(AUTH_FILE_SECRET) && System.IO.File.Exists(Services.AuthStorageService.AUTH_FILE_NAME))
            {
                return System.IO.File.ReadAllText(AUTH_FILE_SECRET);
            }

            string addedRandomSuggestion = string.Empty;
            if (!System.IO.File.Exists(Services.AuthStorageService.AUTH_FILE_NAME))
            {
