...
## Changelog
### 1.0.5.10 Extension to generate dataverse safe guids for datamigration. Save guid id on different entities can cause problems if reffered on the same virtual entity
