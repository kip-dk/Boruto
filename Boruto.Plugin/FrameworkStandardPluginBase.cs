...
namespace Boruto.Plugin
{
    ...
    /// </summary>
    public abstract class FrameworkStandardPluginBase : IPlugin
    {
        protected string PluginClassName { get; }

        /// <summary>
        /// Initializes a new instance of the <see cref="FrameworkStandardPluginBase"/> class.
        /// </summary>
        /// <param name="pluginClassName">The <see cref="Type"/> of the plugin class.</param>
        internal FrameworkStandardPluginBase(Type pluginClassName)
        {
