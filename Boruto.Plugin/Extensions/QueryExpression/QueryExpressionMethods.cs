...
namespace Boruto.Extensions.QueryExpression
{
    public static class QueryExpressionMethods
    {
        ...
        public static Microsoft.Xrm.Sdk.Query.QueryExpression ToQueryExpression(this string logicalName, bool distinct = true)
        {
            var result = new Microsoft.Xrm.Sdk.Query.QueryExpression(logicalName);
            result.ColumnSet = new ColumnSet(true);
            if (distinct)
            {
